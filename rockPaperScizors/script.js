...
const playerScoreText = document.getElementById('playerPoints');
const cpuScoreText = document.getElementById('cpuPoints');
...
function playRound(playerHand, cpuHand) {
  ...
  if (playerHand == cpuHand) {
    tieRound();
    return 'Empate';
  } else if (playerHand == 'pedra' && cpuHand == 'tesoura' ||
             playerHand == 'tesoura' && cpuHand == 'papel' ||
             playerHand == 'papel' && cpuHand == 'pedra') {
    playerWinsRound();
